    ...
    <section className='about-me' id='about-me'>
      ...
      <div className='about-me__resume'>
        <div className='about-me__info'>
          ...
          <p className='about-me__text'>Я родился в Казахстане. Учился и живу в Екатеринбруге. Окончил строительный институт по направлению ОВиК. На данный момент работаю в крупном девелопере на позиции руководителя группы операционного проектирования ОВиК. Люблю музыку, путешествовать и сноубординг и своих друзей.</p>
